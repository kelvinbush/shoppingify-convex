...
import ListAlertModal from "@/components/modals/list-alert-modal";
  ...
  return (
    <>
      <ListAlertModal
        ...
        onConfirm={() => cancelShopList(shoppingList._id)}
        loading={false}
      />
      <div className={"h-full bg-[#FFF0DE] px-4 py-6"}>
        <div
          className={
            "relative mb-2 space-x-6 rounded-3xl bg-[#80485B] px-2 py-4"
          }
        >
          <Image
            height={150}
        ...
        <div
          className={
            "fixed bottom-0 right-0 flex w-[400px] gap-x-4 bg-white p-4"
          }
        >
          {shoppingList.isCompleting ? (
